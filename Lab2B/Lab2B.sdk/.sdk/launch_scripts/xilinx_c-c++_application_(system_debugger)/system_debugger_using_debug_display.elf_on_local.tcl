...
fpga -file /home/eolmos/ECE-153A-Labs/Lab2B/Lab2B.sdk/system_wrapper_hw_platform_0/download.bit
...
after 3000
targets -set -nocase -filter {name =~ "microblaze*#0" && bscan=="USER2"  && jtag_cable_name =~ "Digilent Nexys A7 -100T 210292ABF10AA"} -index 0
dow /home/eolmos/ECE-153A-Labs/Lab2B/Lab2B.sdk/display/Debug/display.elf
targets -set -nocase -filter {name =~ "microblaze*#0" && bscan=="USER2"  && jtag_cable_name =~ "Digilent Nexys A7 -100T 210292ABF10AA"} -index 0
con
