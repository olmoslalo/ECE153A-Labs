...
HD_PWD='/home/eolmos/ECE-153A-Labs/Lab2B/Lab2B.runs/system_auto_ds_7_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_auto_ds_7.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_auto_ds_7.tcl
