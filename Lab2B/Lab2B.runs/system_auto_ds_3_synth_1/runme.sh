...
HD_PWD='/home/eolmos/ECE-153A-Labs/Lab2B/Lab2B.runs/system_auto_ds_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_auto_ds_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_auto_ds_3.tcl
