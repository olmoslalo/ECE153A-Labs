...
HD_PWD='/home/eolmos/ECE-153A-Labs/Lab3A/Lab3A.runs/system_stream_grabber_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_stream_grabber_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_stream_grabber_0_1.tcl
