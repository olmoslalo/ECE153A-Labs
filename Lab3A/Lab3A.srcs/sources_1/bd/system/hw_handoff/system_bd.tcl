...
proc create_hier_cell_mic_block { parentCell nameHier } {
  ...
  # Create instance: nopll_mic_block, and set properties
  set block_name nopll_mic_block
  set block_cell_name nopll_mic_block
  if { [catch {set nopll_mic_block [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $nopll_mic_block eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: stream_grabber, and set properties
  set block_name stream_grabber
  set block_cell_name stream_grabber
  if { [catch {set stream_grabber [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $stream_grabber eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins s_axi_cpu] [get_bd_intf_pins stream_grabber/s_axi_cpu]
  connect_bd_intf_net -intf_net nopll_mic_block_m_axis [get_bd_intf_pins nopll_mic_block/m_axis] [get_bd_intf_pins stream_grabber/s_axis_stream]

  # Create port connections
  connect_bd_net -net mic_data_in_0_1 [get_bd_pins mic_data_in_0] [get_bd_pins nopll_mic_block/mic_data_in]
  connect_bd_net -net nopll_mic_block_mic_clk [get_bd_pins mic_clk_0] [get_bd_pins nopll_mic_block/mic_clk]
  connect_bd_net -net nopll_mic_block_mic_lr_sel [get_bd_pins mic_lr_sel_0] [get_bd_pins nopll_mic_block/mic_lr_sel]
  connect_bd_net -net sys_clk_1 [get_bd_pins sys_clk] [get_bd_pins nopll_mic_block/sys_clk] [get_bd_pins stream_grabber/sys_clk]
  connect_bd_net -net sys_rst_1 [get_bd_pins sys_rst] [get_bd_pins nopll_mic_block/sys_rst] [get_bd_pins stream_grabber/sys_rst]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: axi_gpio_Encoder, and set properties
  set axi_gpio_Encoder [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 axi_gpio_Encoder ]
  set_property -dict [ list \
  ...
  # Create instance: ext_spi_clk, and set properties
  set ext_spi_clk [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:6.0 ext_spi_clk ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M09_AXI [get_bd_intf_pins axi_gpio_Encoder/S_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M09_AXI]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M12_AXI [get_bd_intf_pins mic_block/s_axi_cpu] [get_bd_intf_pins microblaze_0_axi_periph/M12_AXI]
  ...
  # Create port connections
  connect_bd_net -net Encoder_ip2intc_irpt [get_bd_pins axi_gpio_Encoder/ip2intc_irpt] [get_bd_pins microblaze_0_xlconcat/In4]
  ...
  connect_bd_net -net ext_spi_clk_clk_out1 [get_bd_pins ext_spi_clk/clk_out1] [get_bd_pins spi/ext_spi_clk]
  connect_bd_net -net gpio_io_i_0_1 [get_bd_ports btn] [get_bd_pins axi_gpio_btn/gpio_io_i]
  connect_bd_net -net gpio_io_i_0_2 [get_bd_ports JD] [get_bd_pins axi_gpio_Encoder/gpio_io_i]
  ...
  connect_bd_net -net rst_mig_7series_0_100M_peripheral_aresetn [get_bd_pins axi_gpio_Encoder/s_axi_aresetn] [get_bd_pins axi_gpio_btn/s_axi_aresetn] [get_bd_pins axi_gpio_led/s_axi_aresetn] [get_bd_pins axi_gpio_rgbleds/s_axi_aresetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins axi_timer_1/s_axi_aresetn] [get_bd_pins mdm_1/S_AXI_ARESETN] [get_bd_pins mic_block/sys_rst] [get_bd_pins microblaze_0_axi_intc/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/M04_ARESETN] [get_bd_pins microblaze_0_axi_periph/M05_ARESETN] [get_bd_pins microblaze_0_axi_periph/M06_ARESETN] [get_bd_pins microblaze_0_axi_periph/M07_ARESETN] [get_bd_pins microblaze_0_axi_periph/M08_ARESETN] [get_bd_pins microblaze_0_axi_periph/M09_ARESETN] [get_bd_pins microblaze_0_axi_periph/M10_ARESETN] [get_bd_pins microblaze_0_axi_periph/M11_ARESETN] [get_bd_pins microblaze_0_axi_periph/M12_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins microblaze_0_axi_periph/S01_ARESETN] [get_bd_pins mig_7series_0/aresetn] [get_bd_pins rst_mig_7series_0_100M/peripheral_aresetn] [get_bd_pins sevenSeg_0/s00_axi_aresetn] [get_bd_pins spi/s_axi_aresetn] [get_bd_pins spi_dc/s_axi_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x40030000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs axi_gpio_Encoder/S_AXI/Reg] SEG_Encoder_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x40030000 [get_bd_addr_spaces microblaze_0/Instruction] [get_bd_addr_segs axi_gpio_Encoder/S_AXI/Reg] SEG_Encoder_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x40020000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs axi_gpio_rgbleds/S_AXI/Reg] SEG_axi_gpio_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x40020000 [get_bd_addr_spaces microblaze_0/Instruction] [get_bd_addr_segs axi_gpio_rgbleds/S_AXI/Reg] SEG_axi_gpio_0_Reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A20000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs mic_block/stream_grabber/s_axi_cpu/reg0] SEG_stream_grabber_0_reg0
  create_bd_addr_seg -range 0x00010000 -offset 0x44A20000 [get_bd_addr_spaces microblaze_0/Instruction] [get_bd_addr_segs mic_block/stream_grabber/s_axi_cpu/reg0] SEG_stream_grabber_0_reg0
